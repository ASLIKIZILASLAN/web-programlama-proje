...
namespace WebMVC.Controllers
{
	...
	public class AdminBlogController : Controller
	{
		public async  Task<IActionResult> Index(int page=1)
		{
			...
			var responseMessage = await httpClient.GetAsync("https://localhost:7019/api/Blogs/GetAllBlogs");
			...
			return View();
			//https://localhost:7019/api/Blogs/DeleteBlogById/
		}
		[HttpGet]
		public async Task<IActionResult> Delete(string id){
			var httpClient = new HttpClient();
			var responseMessage = await httpClient.GetAsync("https://localhost:7019/api/Blogs/DeleteBlogById/" + id);
			if (responseMessage.IsSuccessStatusCode)
			{
        ...
        public async Task<IActionResult> BlogAdd(AddBlogViewModel blog){
            ...
            var response = await httpclient.PostAsync("https://localhost:7019/api/Users/AddBlog", content);
		...
		public async Task<IActionResult> Edit(string id){
				...
				var httpClient = new HttpClient();
			var responseMessage = await httpClient.GetAsync("https://localhost:7019/api/BlogDetails/GetBlogById/" + id);
			if (responseMessage.IsSuccessStatusCode)
			{
				var jsonBlog = await responseMessage.Content.ReadAsStringAsync();
		...
		public async Task<IActionResult> Edit(BlogByIdViewModel blog)
		{
			...
			StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
			var response = await httpclient.PostAsync("https://localhost:7019/api/BlogDetails/EditBlog", content);
			if (response.IsSuccessStatusCode)
			{
				return RedirectToAction("index", "adminblog");
			}
